    ...
    <div class="p-6 pb-20">
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full p-3 border rounded-lg bg-gray-50" required>
            </div>
            ...
            <button class="w-full bg-blue-600 text-white font-bold py-4 rounded-full shadow-md hover:bg-blue-700 transition">
                ログイン
            </button>
        </form>

        <div class="mt-6 text-center">
            <a href="{{ route('register') }}" class="text-sm text-orange-500 underline">新しく部員登録する</a>
        </div>
    </div>
</x-app-layout>